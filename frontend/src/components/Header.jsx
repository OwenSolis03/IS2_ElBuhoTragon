            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        {/* Agregamos contacto también en el header */}
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-[#141b2d] border-t border-white/10 absolute w-full shadow-2xl">
                    <div className="px-4 pt-2 pb-6 space-y-2 flex flex-col text-center">
                        ...
                        <Link to="/contacto" className="block px-3 py-3 rounded-md text-base font-medium text-gray-300 hover:text-yellow-500 hover:bg-white/5" onClick={() => setIsMenuOpen(false)}>
                            Contacto
                        </Link>

...
const Geologia = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "Paleontólogo", estrellas: 4, texto: "El café ayuda a pasar las horas de laboratorio. ¡Buen lugar!", fecha: "15/11/2025" },
    { id: 2, usuario: "MineroJunior", estrellas: 5, texto: "Excelente para el receso, mucha sombra y rápido.", fecha: "14/11/2025" }
  ]);
  // ---------------------------

  useEffect(() => {
    // id_tiendita=11 para Geología

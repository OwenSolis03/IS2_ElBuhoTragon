...
const CivilMinas = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "IngenieroCivil", estrellas: 4, texto: "Muy buenos los burritos, pero faltan más opciones vegetarianas.", fecha: "14/11/2025" },
    { id: 2, usuario: "EstudianteMinas", estrellas: 5, texto: "Excelente atención y todo limpio.", fecha: "13/11/2025" }
  ]);
  // ---------------------------

  useEffect(() => {
    // id_tiendita=7 para Civil/Minas

...
const PsicologiaComunicacion = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "SociologoX", estrellas: 5, texto: "Perfecto para debatir sobre la conciencia social, ¡y el café es fuerte!", fecha: "15/11/2025" },
    { id: 2, usuario: "HistoriadorNovato", estrellas: 4, texto: "Buenas tortas, aunque el ambiente es un poco ruidoso a veces.", fecha: "14/11/2025" }
  ]);
  // ---------------------------
...
export default PsicologiaComunicacion;
...
const IngenieriaQuimica = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "IngenieroPro", estrellas: 5, texto: "Perfecto para el rush de media mañana. ¡Rápido y bueno!", fecha: "15/11/2025" },
    { id: 2, usuario: "EstudianteSTEM", estrellas: 4, texto: "Buena variedad, aunque el espacio es un poco pequeño.", fecha: "14/11/2025" }
  ]);
  // ---------------------------

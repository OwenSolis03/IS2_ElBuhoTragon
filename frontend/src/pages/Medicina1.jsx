...
const Medicina1 = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "Dr.HouseFan", estrellas: 4, texto: "Excelente para el almuerzo, aunque la espera es larga. ¡Hamburguesas aprobadas!", fecha: "15/11/2025" },
    { id: 2, usuario: "InternoEstresado", estrellas: 5, texto: "El café es mi salvación. Rápido y fuerte.", fecha: "14/11/2025" }
  ]);
  // ---------------------------

  useEffect(() => {
    // id_tiendita=8 para Medicina 1

// src/pages/Matematicas.jsx
import React, { useEffect, useState } from 'react'; 
import Header from "../components/Header";
import Footer from "../components/Footer";
import MatematicasImage from "/Matematicas1Card.png"; // Usamos la imagen correcta
...
const Matematicas = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "Calculista01", estrellas: 5, texto: "¡El mejor café para programar hasta tarde! Excelente servicio.", fecha: "15/11/2025" },
    { id: 2, usuario: "Algebrista", estrellas: 4, texto: "Rápido y bueno, un descanso necesario de las ecuaciones.", fecha: "14/11/2025" }
  ]);
  // ---------------------------

  useEffect(() => {
    // id_tiendita=9 para Matemáticas
  ...
  return (
    <div style={{
      ...
      // Estilo de fondo unificado (Azul Nocturno)
      ...
      <main style={{ flexGrow: 1, padding: "2rem", paddingTop: "7rem" }}>
        ...
        <div style={{
          ...
          <img src={MatematicasImage} alt="Cafetería Matematicas" style={{
            width: "100%",
            maxWidth: "800px",
            height: "auto",

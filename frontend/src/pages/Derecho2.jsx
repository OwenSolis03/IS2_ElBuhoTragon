...
const Derecho2Component = () => { // Renombramos a Derecho2Component para evitar conflicto con la exportación
  const [menuItems, setMenuItems] = useState([]);
  const [loading, setLoading] = useState(true);

  // --- ESTADOS PARA RESEÑAS ---
  const [rating, setRating] = useState(0); // Calificación seleccionada (1-5)
  const [hover, setHover] = useState(0);   // Para efecto al pasar el mouse
  const [comentario, setComentario] = useState("");
  const [reviews, setReviews] = useState([
    // Datos simulados para probar la visualización
    { id: 1, usuario: "AbogadoSenior", estrellas: 4, texto: "Las pizzas pan son rápidas y buenas para el break. Buen lugar.", fecha: "15/11/2025" },
    { id: 2, usuario: "EstudianteDerecho", estrellas: 5, texto: "Excelente para el desayuno antes de las 7am.", fecha: "14/11/2025" }
  ]);
  // ---------------------------
  ...
  return (
    <div style={{
      ...
      // Estilos unificados con el azul Nocturno (#141b2d)
      ...
      <main style={{ flexGrow: 1, padding: "2rem", paddingTop: "7rem" }}>
        ...
        <div style={{
          ...
          <img src={Derecho2} alt="Cafetería Derecho 2" style={{
            width: "100%",
            maxWidth: "800px",
            height: "auto",
...
export default Derecho2Component;
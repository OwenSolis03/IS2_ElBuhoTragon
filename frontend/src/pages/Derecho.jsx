...
const Derecho = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "JuanPerez", estrellas: 5, texto: "¡Las mejores tortas de la uni!", fecha: "12/11/2025" },
    { id: 2, usuario: "MariaG", estrellas: 4, texto: "Muy bueno, pero se llena mucho.", fecha: "10/11/2025" }
  ]);
    ...
    <div style={{
      ...
      <main style={{ flexGrow: 1, padding: "2rem", paddingTop: "7rem" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: "2rem" }}>
          <img src={Derecho1} alt="Cafetería Derecho" style={{
            width: "100%",
            maxWidth: "800px",
            height: "auto",
                  ...
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="flex">
                          {/* ESTRELLAS DE LAS RESEÑAS EXISTENTES */}
                          {[...Array(5)].map((_, i) => (

...
const TrabajoSocial = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "AsistenteSocial", estrellas: 4, texto: "Buena opción para el café, y la nieve es un buen extra.", fecha: "15/11/2025" },
    { id: 2, usuario: "ComiteEstudiantil", estrellas: 5, texto: "Muy limpio y la atención es excelente. Recomendado.", fecha: "14/11/2025" }
  ]);
  // ---------------------------

  useEffect(() => {
    // id_tiendita=2 para Trabajo Social

...
const Medicina2 = () => {
  ...
  const [reviews, setReviews] = useState([
    ...
    { id: 1, usuario: "CirujanoGeek", estrellas: 5, texto: "¡Los burritos son un hit! La mejor opción para comer sin ir lejos.", fecha: "15/11/2025" },
    { id: 2, usuario: "EnfermeraRuth", estrellas: 4, texto: "Muy buena variedad de snacks y bebidas frías.", fecha: "14/11/2025" }
  ]);
  // ---------------------------

  useEffect(() => {
    // id_tiendita=13 para Medicina 2
